...
const About = () => {
  ...
  return <section id="about" className="py-20 bg-gray-50 dark:bg-cyber-dark/80 section-padding">
 ...
 I enjoy both teamwork and individual problem solving, and I'm always eager to learn new skills in the ever-changing field of technology.</p>
          ...
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {skills.map(skill => <Card key={skill.name} className="card-hover">
                  <CardContent className="p-4">
                    <div className="mb-2">
                      <span className="font-medium text-cyber-dark dark:text-white">{skill.name}</span>
                    </div>
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                      <div className="bg-cyber-blue dark:bg-cyber-blue-light h-2.5 rounded-full" style={{
                    width: `${skill.level}%`
                  }}></div>
                    </div>
                  </CardContent>
