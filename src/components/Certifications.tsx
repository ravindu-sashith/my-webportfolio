...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-20 bg-gray-50 dark:bg-cyber-dark/80 section-padding">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-cyber-gray dark:text-gray-300 max-w-2xl mx-auto">
            Professional certifications and specialized training in cybersecurity and digital forensics.
          </p>
        </div>
